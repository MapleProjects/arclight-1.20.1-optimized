...
implements Directional {
    ...
    public void setHeadOfBed(boolean isHeadOfBed) {
        this.setData((byte)(isHeadOfBed ? this.getData() | 8 : this.getData() & 0xFFFFFFF7));
    }
    ...
    public String toString() {
        return String.valueOf(this.isHeadOfBed() ? "HEAD" : "FOOT") + " of " + super.toString() + " facing " + (Object)((Object)this.getFacing());
    }
