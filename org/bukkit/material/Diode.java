...
Redstone {
    ...
    public String toString() {
        return String.valueOf(super.toString()) + " facing " + (Object)((Object)this.getFacing()) + " with " + this.getDelay() + " ticks delay";
    }
    ...
    public boolean isPowered() {
        return this.getItemType() == Material.LEGACY_DIODE_BLOCK_ON;
    }
}
