...
extends MaterialData {
    ...
    public Mushroom(Material shroom) {
        super(shroom);
        Preconditions.checkArgument((shroom == Material.LEGACY_HUGE_MUSHROOM_1 || shroom == Material.LEGACY_HUGE_MUSHROOM_2 ? 1 : 0) != 0, (Object)"Not a mushroom!");
    }
    ...
    public String toString() {
        return this.getItemType() + (this.isStem() ? " STEM " : " CAP ") + this.getPaintedFaces();
    }
