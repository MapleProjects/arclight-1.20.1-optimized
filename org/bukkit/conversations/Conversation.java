...
public class Conversation {
    ...
    public void acceptInput(@NotNull String input) {
        if (this.currentPrompt != null) {
            if (this.localEchoEnabled) {
                this.context.getForWhom().sendRawMessage(String.valueOf(this.prefix.getPrefix(this.context)) + input);
            }
    ...
    public void outputNextPrompt() {
        if (this.currentPrompt == null) {
            ...
            this.context.getForWhom().sendRawMessage(String.valueOf(this.prefix.getPrefix(this.context)) + this.currentPrompt.getPromptText(this.context));
