...
public class CraftBlastingRecipe
...
implements CraftRecipe {
    ...
    public void addToCraftingManager() {
        ...
        MinecraftServer.getServer().m_129894_().addRecipe((Recipe)new net.minecraft.world.item.crafting.BlastingRecipe(CraftNamespacedKey.toMinecraft(this.getKey()), this.getGroup(), CraftRecipe.getCategory(this.getCategory()), this.toNMS(this.getInputChoice(), true), CraftItemStack.asNMSCopy(result), this.getExperience(), this.getCookingTime()));
    }
}
