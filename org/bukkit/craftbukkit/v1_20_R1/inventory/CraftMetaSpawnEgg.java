...
implements SpawnEggMeta {
    ...
    public CraftMetaSpawnEgg(CraftMetaItem meta) {
        super(meta);
        if (!(meta instanceof CraftMetaSpawnEgg var2_3)) {
            return;
        }
    ...
    CraftMetaSpawnEgg(CompoundTag tag) {
        super(tag);
        if (tag.m_128441_(CraftMetaSpawnEgg.ENTITY_TAG.NBT)) {
            this.entityTag = tag.m_128469_(CraftMetaSpawnEgg.ENTITY_TAG.NBT).m_6426_();
        }
    }
    ...
    void deserializeInternal(CompoundTag tag, Object context) {
        ...
        if (tag.m_128441_(CraftMetaSpawnEgg.ENTITY_TAG.NBT)) {
            Map map;
            String entityType;
            this.entityTag = tag.m_128469_(CraftMetaSpawnEgg.ENTITY_TAG.NBT);
            if (context instanceof Map && (entityType = CraftMetaItem.SerializableMeta.getString(map = (Map)context, CraftMetaSpawnEgg.ENTITY_ID.BUKKIT, true)) != null) {
                this.spawnedType = EntityType.fromName(entityType);
            }
            if (this.spawnedType != null) {
                this.entityTag.m_128473_(CraftMetaSpawnEgg.ENTITY_ID.NBT);
            }
            this.entityTag.m_128456_();
            if (this.entityTag.m_128441_(CraftMetaSpawnEgg.ENTITY_ID.NBT)) {
                this.spawnedType = EntityType.fromName(new ResourceLocation(this.entityTag.m_128461_(CraftMetaSpawnEgg.ENTITY_ID.NBT)).m_135815_());
            }
        }
    }
    ...
    void serializeInternal(Map<String, Tag> internalTags) {
        if (this.entityTag != null && !this.entityTag.m_128456_()) {
            internalTags.put(CraftMetaSpawnEgg.ENTITY_TAG.NBT, (Tag)this.entityTag);
        }
    }
    ...
    void applyToItem(CompoundTag tag) {
        ...
        if (this.entityTag != null) {
            tag.m_128365_(CraftMetaSpawnEgg.ENTITY_TAG.NBT, (Tag)this.entityTag);
        }
    }
    ...
    boolean equalsCommon(CraftMetaItem meta) {
        ...
        if (meta instanceof CraftMetaSpawnEgg) {
            ...
            return this.hasSpawnedType() ? that.hasSpawnedType() && this.spawnedType.equals(that.spawnedType) : (!that.hasSpawnedType() && this.entityTag != null ? that.entityTag != null && this.entityTag.equals((Object)that.entityTag) : this.entityTag == null);
        }
        return true;
    }
