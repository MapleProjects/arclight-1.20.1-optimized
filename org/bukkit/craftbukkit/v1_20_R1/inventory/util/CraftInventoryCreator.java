...
import org.bukkit.craftbukkit.v1_20_R1.inventory.util.CraftCustomInventoryConverter;
...
public final class CraftInventoryCreator {
    ...
    public Inventory createInventory(InventoryHolder holder, InventoryType type) {
        return this.converterMap.get((Object)type).createInventory(holder, type);
    }

    public Inventory createInventory(InventoryHolder holder, InventoryType type, String title) {
        return this.converterMap.get((Object)type).createInventory(holder, type, title);
    }
