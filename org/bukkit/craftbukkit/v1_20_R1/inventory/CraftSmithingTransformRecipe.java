...
public class CraftSmithingTransformRecipe
...
implements CraftRecipe {
    ...
    public void addToCraftingManager() {
        ...
        MinecraftServer.getServer().m_129894_().addRecipe((Recipe)new net.minecraft.world.item.crafting.SmithingTransformRecipe(CraftNamespacedKey.toMinecraft(this.getKey()), this.toNMS(this.getTemplate(), true), this.toNMS(this.getBase(), true), this.toNMS(this.getAddition(), true), CraftItemStack.asNMSCopy(result)));
    }
}
