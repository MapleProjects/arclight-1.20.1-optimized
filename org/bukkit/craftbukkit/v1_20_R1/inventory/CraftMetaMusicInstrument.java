...
implements MusicInstrumentMeta {
    ...
    CraftMetaMusicInstrument(CompoundTag tag) {
        super(tag);
        if (tag.m_128441_(CraftMetaMusicInstrument.GOAT_HORN_INSTRUMENT.NBT)) {
            String string = tag.m_128461_(CraftMetaMusicInstrument.GOAT_HORN_INSTRUMENT.NBT);
    ...
    void applyToItem(CompoundTag tag) {
        ...
        if (this.instrument != null) {
            tag.m_128359_(CraftMetaMusicInstrument.GOAT_HORN_INSTRUMENT.NBT, this.instrument.getKey().toString());
        }
    }
