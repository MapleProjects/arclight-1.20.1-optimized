...
public final class CommandPermissions {
    ...
    public static Permission registerPermissions(Permission parent) {
        ...
        DefaultPermissions.registerPermission("minecraft.command.msg", "Allows the user to privately message another player", PermissionDefault.TRUE, commands);
        DefaultPermissions.registerPermission("minecraft.command.help", "Allows the user to access Vanilla command help", PermissionDefault.TRUE, commands);
