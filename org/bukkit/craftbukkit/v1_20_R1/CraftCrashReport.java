...
implements Supplier<String> {
    ...
    public String get() {
        ...
        try {
            value.append("\n   Running: ").append(Bukkit.getName()).append(" version ").append(Bukkit.getVersion()).append(" (Implementing API version ").append(Bukkit.getBukkitVersion()).append(") ").append(String.valueOf(MinecraftServer.getServer().m_129797_()));
            value.append("\n   Plugins: {");
            ...
            for (World world : Bukkit.getWorlds()) {
                ...
                for (Map.Entry entry : world.getPluginChunkTickets().entrySet()) {
