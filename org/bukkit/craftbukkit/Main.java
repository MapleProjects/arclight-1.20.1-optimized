    ...
    public static void main(String[] args) {
        ...
        if (options == null || options.has("?")) {
            ...
            try {
                ...
                boolean bl = useJline = !jline_UnsupportedTerminal.equals(System.getProperty(jline_terminal));
                ...
                net.minecraft.server.Main.main((OptionSet)options);
            }
            catch (Throwable t) {
                t.printStackTrace();
            }
