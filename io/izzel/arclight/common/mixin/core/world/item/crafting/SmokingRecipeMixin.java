...
@Mixin(value={SmokingRecipe.class})
public abstract class SmokingRecipeMixin
extends AbstractCookingRecipe
implements IRecipeBridge {
    public SmokingRecipeMixin(RecipeType<?> p_250197_, ResourceLocation p_249379_, String p_249518_, CookingBookCategory p_250891_, Ingredient p_251354_, net.minecraft.world.item.ItemStack p_252185_, float p_252165_, int p_250256_) {
    ...
    public org.bukkit.inventory.Recipe bridge$toBukkitRecipe() {
        ...
        CraftSmokingRecipe recipe = new CraftSmokingRecipe(CraftNamespacedKey.fromMinecraft(this.m_6423_()), (ItemStack)result, CraftRecipe.toBukkit(this.f_43729_), this.f_43731_, this.f_43732_);
